...
You won, GG bro""")
    ...
    # lose
    print("""You died.
Your body was later found by a passerby in the forest, you died by eating a poisonous mushroom or a bear killed you, we don't know.
However, what we do know is that you lost the game. get rekt lol""")
